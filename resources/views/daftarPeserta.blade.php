				...
				<div class="col-md-3">
					<div class="faq-list">
						<ul class="list-group list-group-flush">
							...
							@endif
							<li
								class="list-group-item text-start bg-gerak-jalan {{$selid == $item->id ? 'active' : ''}}">
								<a href="{{route('daftar-peserta', ['id' => $item->id])}}"
									class="d-flex align-items-center"><i class="bx bx-flag me-2"></i>
									{{$item->judul}}</a>
							</li>
							@php($a = $item->id_lomba)
							@endforeach
						...
						<table class="table table-striped table-sm" id="datatablesSimple">
							<thead class="table-dark">
								<tr class="text-center">
									...
									<th width="55%">Nama Regu/Instansi</th>
