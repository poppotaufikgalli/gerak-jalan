				...
				<form action="{{route('daftar-umum')}}" method="post" role="form" class="php-email-form">
					...
					<div class="row">
						<div class="col-md-6 form-group form-check">
							...
							<label class="form-check-label fw-semibold" for="pakta">Saya Bersedia mengisi <a href="#" target="_blank" class="text-decoration-underline">Pakta Integritas</a></label>
						</div>
					</div>
